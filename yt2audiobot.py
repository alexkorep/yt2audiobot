...
if __name__ == '__main__':
    ...
    try:
        settings.BOT_SECRETS['yt2audiobot_root'] = os.environ.get('yt2audiobot_root')
        settings.BOT_SECRETS['telegram_token'] = os.environ.get('telegram_token')
        settings.BOT_SECRETS['musixmatch_key'] = os.environ.get('musixmatch_key')
        settings.BOT_SECRETS['spotify_client_id'] = os.environ.get('spotify_client_id')
        settings.BOT_SECRETS['spotify_client_secret'] = os.environ.get('spotify_client_secret')
